    ...
    <CContainer fluid className="md:px-24">
      <CContainer fluid className="flex flex-col md:flex-row ">
        <CContainer fluid>
          ...
          <ul>
            <li className="text-style-26 w-60 pt-2">
        ...
        <CContainer fluid>
          <CRow xs={{ cols: 2, gutter: 4 }} md={{ cols: 4 }}>
            <CCol>
              ...
              <ul>
                <li className="text-style-26 pt-2">회사 소개</li>
                <li className="text-style-26 pt-2">인재 채용</li>
                <li className="text-style-26 pt-2">상시 할인 혜택</li>
              </ul>
            </CCol>
            <CCol>
              <span className="text-style-15 text-blackTwo">My order</span>
              <ul>
                <li className="text-style-26 pt-2">내 주문</li>
                <li className="text-style-26 pt-2">주문 배송</li>
                <li className="text-style-26 pt-2">취소 / 교환 / 반품 내역</li>
                <li className="text-style-26 pt-2">상품 리뷰 내역</li>
                <li className="text-style-26 pt-2">증빙 서류 발급</li>
              </ul>
            </CCol>
            <CCol>
              <span className="text-style-15 text-blackTwo">My account</span>
              <ul>
                <li className="text-style-26 pt-2">회원 정보 수정</li>
                <li className="text-style-26 pt-2">회원 등급</li>
                <li className="text-style-26 pt-2">마일리지 현황</li>
                <li className="text-style-26 pt-2">쿠폰</li>
              </ul>
            </CCol>
            <CCol>
              <span className="text-style-15 text-blackTwo">Help</span>
              <ul>
                <li className="text-style-26 pt-2">1 : 1 상담 내역</li>
                <li className="text-style-26 pt-2">상품 Q & A 내역</li>
                <li className="text-style-26 pt-2">공지 사항</li>
                <li className="text-style-26 pt-2">자주하는 질문</li>
                <li className="text-style-26 pt-2">고객의 소리</li>
              </ul>
            </CCol>
          </CRow>
        </CContainer>
      ...
      >
        ...
        <div className="flex items-center mt-2">
          <img src={snsIcon01} alt="icon" className="w-6 h-6" />
          <img src={snsIcon02} alt="icon" className="w-6 h-6" />
          <img src={snsIcon03} alt="icon" className="w-6 h-6" />
        </div>
      </CContainer>
    </CContainer>
  );
